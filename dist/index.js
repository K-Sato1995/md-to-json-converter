...
var converteMdToJSON = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var contentPath, outputPath, raw, parser, doseParse, mdFiles, jsonObj;
    return __generator(this, function (_a) {
        ...
        jsonObj = (0, builder_1.constructJSONObj)(parser, mdFiles, doseParse);
        (0, utils_1.writeJSON)(outputPath, jsonObj);
        return [2 /*return*/, jsonObj];
    });
}); };
exports.converteMdToJSON = converteMdToJSON;
var validateOptions = function (options) {
    var contentPath = options.contentPath, outputPath = options.outputPath;
    if (!contentPath)
        throw new Error('\'contentPath\' is required');
    if (!outputPath)
